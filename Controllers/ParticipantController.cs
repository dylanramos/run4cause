...
namespace run4cause.Controllers
{
    public class ParticipantController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LastName,FirstName")] Participant participant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LastName,FirstName")] Participant participant)
        {
